...
public class SalesReportUpdateAdapter extends BaseExpandableListAdapter {
    //Declares variables
    ...
    //Constructor
    public SalesReportUpdateAdapter(Activity context, ArrayList<GasPumps> headerList, HashMap<GasPumps, ArrayList<PumpLinesAdd>> childList){
    ...
    public View getChildView(int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            PumpLinesUpdateAdapter pumpLinesAdapter = new PumpLinesUpdateAdapter(this.context, resultList, groupPosition);
